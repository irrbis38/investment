...
function headerInit(){langMenuHandler(),changeLang(),toggleMobileMenu()}function langMenuHandler(){const e=document.querySelector(".lang");e.addEventListener("mouseenter",()=>{e.classList.add("active")}),e.addEventListener("mouseleave",()=>{e.classList.remove("active")})}function changeLang(){const n=document.querySelector(".lang");var e=document.querySelector(".lang__selected");const r=e.children[0].children[0],i=e.children[1],o=document.querySelectorAll(".lang__item");o.forEach(e=>{e.addEventListener("click",e=>{var t,e=e.currentTarget;e.classList.contains("selected")||(o.forEach(e=>e.classList.remove("selected")),e.classList.add("selected"),n.classList.remove("active"),t=e.children[0].children[0].getAttribute("src"),e=e.dataset.lang,r.setAttribute("src",t),r.setAttribute("alt",e),i.textContent=e)})})}function getHeaderElements(){return[".header",".header__burger",".auth",".header__logo",".header__panel",".header__nav"].map(e=>document.querySelector(e))}function toggleMobileMenu(){const e=getHeaderElements(),t=document.querySelector(".header__burger");t.addEventListener("click",()=>{t.classList.contains("active")?createHeaderTimeline("0"):createHeaderTimeline("-28px"),e.forEach(e=>e.classList.toggle("active")),document.body.classList.toggle("lock")})}function createHeaderTimeline(e){return gsap.timeline({duration:.1,ease:Power3.easeOut}).to([".header__logo",".header__panel"],{y:e})}document.addEventListener("DOMContentLoaded",function(e){headerInit(),document.querySelector(".intro")&&introInit()}),gsap.registerPlugin(ScrollTrigger);const mqMD=window.matchMedia("(min-width: 1281px)");function removeHeaderNavTransition(){return gsap.timeline().set(".header__nav",{display:"none"}).set(".header__nav",{clearProps:"all"},"+=0.4")}function introInit(){const e=Array.from(document.querySelectorAll(".pagination__item"));var t=document.querySelector(".intro__btn"),n=document.querySelector(".pagination").children[0];gsap.set(n,{scale:1.42,opacity:1}),introSignupHandler(),introAnimationByNumber(e),t.addEventListener("click",()=>{introAnimationByNext(e)}),resonsSliderInit(),infoCenterSliderInit(),mainPageAnimation()}function introSignupHandler(){var e=document.querySelector(".intro__signup"),t=document.querySelector(".intro__bg");const n={introArrow:e.querySelector(".intro__signup .svg-image-intro-arrow-up-45-white"),introBG:t,startGradient:"linear-gradient(277.24deg, #071b64 33.49%, #265792 104.72%)",endGradient:"linear-gradient(277.66deg, #071B64 -57.44%, #3368A5 105.08%)",duration:.2};e.addEventListener("mouseenter",()=>{introSignupPlay({...n,direction:"forward"})}),e.addEventListener("mouseleave",()=>{introSignupPlay({...n,direction:"backward"})})}function introSignupPlay(e){var{introArrow:e,introBG:t,startGradient:n,endGradient:r,duration:i,direction:o}=e,a=gsap.timeline();return"forward"===o?a.to(e,i,{rotate:45}).fromTo(t,i,{background:n},{background:r},0):a.to(e,i,{rotate:0}).fromTo(t,i,{background:r},{background:n},0)}function introAnimationByNumber(i){i.forEach(e=>e.addEventListener("click",e=>{var t,n,r,e=e.target;e.classList.contains("active")||(t=i.find(e=>e.classList.contains("active")),n=Number(t.dataset.index),r=i.indexOf(e),i.forEach(e=>e.classList.remove("active")),e.classList.add("active"),n<r?introSliderAnimation(n,r,"forward",!1):r<n&&introSliderAnimation(n,r,"backward",!1),paginationAnimation(r,t,e))}))}function introAnimationByNext(e){var t=e.findIndex(e=>e.classList.contains("active")),n=e[t],r=t===e.length-1?e[0]:e[t+1];t===e.length-1?(paginationAnimation(0,n,r),setActiveItem(e,0),introSliderAnimation(t,0,"backward",!0)):(paginationAnimation(t+1,n,r),setActiveItem(e,t+1),introSliderAnimation(t,t+1,"forward",!1))}function setActiveItem(e,t){e.forEach(e=>e.classList.remove("active")),e[t].classList.add("active")}function paginationAnimation(e,t,n){var r=document.querySelector(".pagination__pointer"),i=document.querySelector(".intro__btn"),o=Array.from(document.querySelectorAll(".pagination__item"));let a="0";switch(e){case 0:a="0";break;case 1:a="47px";break;case 2:a="94px"}gsap.timeline().set([i,...o],{disabled:!0}).to(r,{duration:1,ease:Power3.easeOut,x:a}).to(t,{duration:.3,scale:1,opacity:.5},"-=0.8").to(n,{duration:.2,scale:1.42,opacity:1},"-=0.4").set([i,...o],{disabled:!1})}function introSliderAnimation(e,t,n,r){var{slides:i,contentItems:o}=createSlidesArray(e,t),{prevSup:e,prevTitle:t,prevImg:a,nextSup:c,nextTitle:s,nextImg:l}=defineAnimatedElements(e,t),d=document.querySelector(".intro__foreground");let u="-100%",m="0";"forward"===n?(u="-100%",m="0"):"backward"===n&&(u="0",m="-100%");n=gsap.timeline({defaults:{duration:r?.8:1}}).to(i,{x:u,ease:Power4.easeOut}).to(o,{x:m,ease:Power4.easeOut},0).to(e,{x:"30px"},0).to(t,{x:"50px"},0).to(a,{scale:"1.2"},0).fromTo(c,{x:"30px"},{x:"0"},0).fromTo(s,{x:"50px"},{x:"0"},0).fromTo(l,{scale:"1.2"},{scale:"1"},0);r&&n.to(d,{x:"0",duration:.4,ease:Power4.easeOut},0).to(d,{x:"100vw",duration:.7,ease:Power4.easeOut},"-=0.4").to(d,{x:"-100vw",duration:0},"+=0.5")}function createSlidesArray(e,t){var n=Array.from(document.querySelectorAll(".intro__item")),r=Array.from(document.querySelectorAll(".intro__content"));let i=[],o=[];return o=e<t?(i=[...n.slice(e+1,t+1)],[...r.slice(e+1,t+1)]):(i=[...n.slice(t+1,e+1)],[...r.slice(t+1,e+1)]),{slides:i,contentItems:o}}function defineAnimatedElements(e,t){var n=Array.from(document.querySelectorAll(".intro__item")),e=n[e],n=n[t];return{prevSup:e.querySelector(".intro__suptitle"),prevTitle:e.querySelector(".intro__title"),prevImg:e.querySelector("img"),nextSup:n.querySelector(".intro__suptitle"),nextTitle:n.querySelector(".intro__title"),nextImg:n.querySelector("img")}}function resonsSliderInit(){new Swiper(".resons__slider",{loop:!1,slidesPerView:"auto",spaceBetween:38,grabCursor:!0,scrollbar:{el:".resons__scrollbar",draggable:!0,dragSize:"auto"}})}function infoCenterSliderInit(){new Swiper(".ic__slider",{loop:!1,slidesPerView:"auto",spaceBetween:36,grabCursor:!0,scrollbar:{el:".ic__scrollbar",draggable:!0,dragSize:"auto"},breakpoints:{577:{spaceBetween:43},769:{spaceBetween:51},993:{spaceBetween:59}}})}function mainPageAnimation(){var e=document.querySelector(".intro__container"),t=document.querySelector(".info__inner"),n=document.querySelector(".info__background"),r=document.querySelector(".info__club"),i=Array.from(document.querySelectorAll(".resons__slide"));pinIntroContainer(e),parallaxInfoInner(t),pinInfoBackground(n),parallaxInfoClub(r),translateResonsSlides(i)}function pinIntroContainer(e){let t=0;return window.innerHeight<700&&(t=700-window.innerHeight),window.addEventListener("resize",()=>{t=window.innerHeight<700?700-window.innerHeight:0}),ScrollTrigger.create({trigger:"body",start:()=>"top top-="+t,endTrigger:"body",end:"bottom -=100",pin:e,pinSpacing:!1,scrub:!0})}function parallaxInfoInner(e){return gsap.from(e,{y:-150,scrollTrigger:{trigger:".info",start:"top bottom",end:"top center",scrub:!0}})}function pinInfoBackground(e){gsap.timeline().to(e,{scrollTrigger:{trigger:e,start:"center center",endTrigger:".ic__link",end:"bottom center-=1%",pin:e,scrub:!0}})}function parallaxInfoClub(e){return gsap.to(e,{y:-200,scrollTrigger:{trigger:e,start:"top bottom",end:"bottom top",scrub:!0}})}function translateResonsSlides(e){let t=0;e.forEach(e=>(t+=8,gsap.from(e,{autoAlpha:0,yPercent:t,scrollTrigger:{trigger:e,start:"top bottom",end:"top center",scrub:!0}})))}function initialAnimation(){gsap.timeline().to(".overlay__blue",{autoAlpha:0,duration:1.2}).from(".intro__title",{yPercent:20,duration:1,ease:Power1.easeNone},0).from(".intro__line",{width:"40%",duration:1,ease:Power1.easeOut},0).from(".intro__signup",{yPercent:90,duration:1,ease:Power1.easeOut},0).from(".intro__image img",{scale:1.3,duration:1.2,ease:Power3.easeOut},0).from(".intro__next",{scale:.5,duration:1.2,ease:Power3.easeOut},0)}mqMD.addEventListener("change",()=>{1280<window.innerWidth?(removeHeaderNavTransition(),createHeaderTimeline("0"),document.body.classList.remove("lock"),getHeaderElements().forEach(e=>e.classList.remove("active"))):removeHeaderNavTransition()}),window.addEventListener("load",()=>{document.querySelector(".intro")&&initialAnimation()});