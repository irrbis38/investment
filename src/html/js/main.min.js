...
function headerInit(){const e=document.querySelectorAll(".lang__select");e.forEach(e=>{new Choices(e,{allowHTML:!1,searchEnabled:!1,itemSelectText:""})})}document.addEventListener("DOMContentLoaded",function(e){headerInit()});